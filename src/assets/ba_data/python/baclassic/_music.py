...
ASSET_SOUNDTRACK_ENTRIES: dict[MusicType, AssetSoundtrackEntry] = {
    ...
    MusicType.TWO_O_ONE_X: AssetSoundtrackEntry('201XMusic', volume=0.3),
    MusicType.BROKEN: AssetSoundtrackEntry('brokenMusic', volume=0.8),
    MusicType.EVENING_BUMP: AssetSoundtrackEntry(
        'eveningBumpMusic', volume=0.8
    ),
    MusicType.OVERTIME: AssetSoundtrackEntry('overtimeMusic'),
    MusicType.DONT_SMOKE_MY_WEED: AssetSoundtrackEntry('dontSmokeMyWeedMusic'),
    MusicType.NIGHT_TIME_CHILL: AssetSoundtrackEntry('nightTimeChillMusic'),
}
