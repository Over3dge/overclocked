...
POWERUP_NAMES = {
    'powerupPap': 'Pack-A-Punch',
    'powerupUno': 'Damage-Reflector',
    'powerupInv': 'Invincibility',
    'powerupBigBombs': 'Bigger-Bombs',
    'powerupLightBombs': 'Lightweight-Bombs',
    'powerupSpeed': 'Running-Shoes',
    'powerupPowerups': 'Power-Pack',
    'powerupBot': 'BUDDY-9000',
    'powerupImpulseBombs': 'Impulse-Bombs',
    'powerupIcepactBombs': 'Ice-Trigger-Bombs',
    'powerupWonderBombs': 'Wonder-Bombs',
    'powerupPortal': 'Specialized-Spaz-Teleportation-Module',
    'powerup0g': 'Zero-Gravity-Box-Module',
    'powerupCoins': 'Coin-Modules',
    'powerupDev': 'Black-Hole-Module',
}
POWERUP_DESCS = {
    'powerupPap': 'Makes your punches explosive\nbased on how hard you punch.',
    'powerupUno': 'Inflicts a bit of your enemy\'s\ndamage back at them and you'
    '\ntake less damage.',
    'powerupInv': 'Makes you invincible\nfor one hit only.',
    'powerupBigBombs': 'Makes your bombs and\ntheir explosions bigger.\nWasn\'t'
    ' obvious at all',
    'powerupLightBombs': 'Makes your bombs lighter\nso you can throw them'
    ' farther.\nAgain, wasn\'t obvious.',
    'powerupSpeed': 'Super speed when you try to run.\nNot effective on ice or'
    ' when\nholding things.',
    'powerupPowerups': 'A pack of three other\nrandom powerups.',
    'powerupBot': 'Enemy robot reverse engineered\nand modified to be your'
    ' friend :D',
    'powerupImpulseBombs': 'Very heavy and big explosion,\nknocks anything off'
    ' the map.',
    'powerupIcepactBombs': 'These come in packs of 3:\nMix of Trigger and Ice'
    ' bombs.\nWho would\'ve thought?',
    'powerupWonderBombs': 'These come in packs of 2:\nNot even I know how\nthey'
    ' work.',
    'powerupPortal': 'By golly! A portal?!\nWhere have I seen\nthis before???',
    'powerup0g': 'A box that defies\ngravity when held.\nSounds familiar...',
    'powerupCoins': 'These come in packs of 4:\nLaunches itself towards the'
    '\nclosest enemy after getting punched.\nInspired by'
    ' ULTRAKILL.',
    'powerupDev': 'From the depths of\nmy super secret labs,\npresenting a'
    ' fucking black hole.',
}
    ...
    def __init__(
        ...
        bui.textwidget(
            ...
            text=bui.Lstr(
                ...
                subs=[('${APP_NAME}', 'BombSquad: OVERCLOCKED')],
            ),
        ...
        logo_tex = bui.gettexture('overclockedLogo')
        icon_buffer = 1.1
        ...
        bui.textwidget(
            ...
            text='Some days you just wanna play vanilla, but it just'
                 ' doesn\'t feel chaotic enough.',
            h_align='center',
            color=paragraph,
            v_align='center',
            flatness=1.0,
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=self._sub_width * 0.9,
            text='Or you wanna play a modpack but you feel something just'
                 ' isn\'t sticking right with you.',
            h_align='center',
            color=paragraph,
            v_align='center',
            flatness=1.0,
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            flatness=1.0,
            text='BombSquad: OVERCLOCKED can help.',
            h_align='center',
            color=paragraph,
            v_align='center',
        )
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=self._sub_width * 0.9,
            text='OVERCLOCKED has a few extra mechanics to make the game a bit'
            ' more interesting:',
            h_align='center',
            color=paragraph,
            v_align='center',
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=500,
            text='These make your game a bit more beautiful (or they may just'
            ' hurt your eye)\nand they make the game more chaotic by randomly'
            ' throwing bombs or powerups\nat you out of nowhere.',
            h_align='left',
            color=paragraph,
            flatness=1.0,
        )
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=500,
            text='Chosen randomly at the start of each activity, they unleash'
            ' chaos by having\nyou adapt to new conditions you haven\'t'
            ' experienced before, from low gravity\nto getting a new powerup'
            ' every 5 seconds. Oh and by the way, they may or may\nnot get'
            ' OVERCHARGED every once in a while, be careful.',
            h_align='left',
            color=paragraph,
            flatness=1.0,
        )
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=500,
            text='Chaos knows no limitations, and time limits are a limitation,'
            ' so I changed the\nstandard time limit! Now some gametypes will'
            ' enter this mode after the\ncountdown hits zero, each gametype has'
            ' its own gimmick for OVERTIME. You\ncan tell if an activity is'
            ' meeting OVERTIME conditions if the countdown is blue.',
            h_align='left',
            color=paragraph,
            flatness=1.0,
        )
        ...
        bui.textwidget(
            ...
            scale=txt_scale,
            maxwidth=500,
            text='Allows you to stack as many "pack" powerups as you want on'
            ' top of eachother.\nWhere does poor Spaz put all of these items'
            ' in? You wouldn\'t want to know\nthe answer.',
            h_align='left',
            color=paragraph,
            flatness=1.0,
        )
        ...
        for tex in [
            ...
            name = POWERUP_NAMES.get(tex) or bui.Lstr(
                resource=self._r + '.' + tex + 'NameText'
            )
            desc = POWERUP_DESCS.get(tex) or bui.Lstr(
                resource=self._r + '.' + tex + 'DescriptionText'
            )
