...
class CreditsListWindow(bui.Window):
    ...
    def __init__(self, origin_widget: bui.Widget | None = None):
        ...
        credits_text = (
            'OVERCLOCKED credits:\n\n   Project Lead and Programming by'
            ' Era0S\n\n   Musical Flags and Volleyball Gametypes and Arms Race,'
            ' Frozen One, and Icy Emits Gametype\n   Ports by Freakyy\n\n   '
            'Running Bombs Gametype by Froshlee14 and SEBASTIAN2059\n\n   Quake'
            ' Gametype Port by Doffy\n\n   Artwork by SoK\n\n   Music by'
            ' Komasio71 and CKSQ\n\n   Many Early Ideas by 0ern7\n\n   '
            'Playtesting:\n\n      Era0S, Komasio71, SoK, 0ern7, TrialTemp,'
            ' Breaker, Everyone Who Played on bs9 Servers,\n      and You,'
            ' by Playing This Demo!\n\n'
            'BombSquad Credits:'
            '\n\n  '
