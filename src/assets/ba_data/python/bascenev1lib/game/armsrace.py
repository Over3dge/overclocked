...
states = [State(bomb='normal', name='Basic Bombs'),
          State(bomb='ice', name='Ice Bombs'),
          State(bomb='sticky', name='Sticky Bombs'),
          State(bomb='impact', name='Trigger Bombs'),
          State(bomb='icepact', name='Ice Trigger Bombs'),
          State(bomb='impulse', name='Impulse Bombs'),
    ...
    def get_available_settings(
        ...
        for state in states:
            if not state.required:
                settings.append(bs.BoolSetting(state.get_setting(),
                                               default=True))
