...
class HockeyGame(bs.TeamGameActivity[Player, Team]):
    ...
    def __init__(self, settings: dict):
        ...
        self._overtime_timer: bs.Timer | None = None
    ...
    def _handle_score(self) -> None:
        ...
        puck = bs.getcollision().opposingnode.getdelegate(Puck, True)
    ...
    def _spawn_puck(self) -> None:
        ...
        psp[1] += len(self._pucks) * 0.3
        self._pucks.append(Puck(position=psp))
    ...
    def overtime_description(self) -> str:
        return 'An extra puck will be dropped into the game every 10 seconds'

    def overtime(self) -> None:
        self._spawn_puck()
        self._overtime_timer = bs.Timer(
            10, bs.WeakCall(self._spawn_puck), True
        )
