...
def register_appearances() -> None:
    ...
    if False:
        # Custom characters here

        # Mr. Overclocked #########################
        t = Appearance('Mr. Overclocked')
        t.color_texture = 'mroColor'
        t.color_mask_texture = 'mroColorMask'
        t.icon_texture = 'neoSpazIcon'
        t.icon_mask_texture = 'neoSpazIconColorMask'
        t.head_mesh = 'mroHead'
        t.torso_mesh = 'mroTorso'
        t.pelvis_mesh = 'mroPelvis'
        t.upper_arm_mesh = 'mroUpperArm'
        t.forearm_mesh = 'mroForeArm'
        t.hand_mesh = 'mroHand'
        t.upper_leg_mesh = 'mroUpperLeg'
        t.lower_leg_mesh = 'mroLowerLeg'
        t.toes_mesh = 'mroToes'
        t.jump_sounds = ['spazJump01', 'spazJump02', 'spazJump03', 'spazJump04']
        t.attack_sounds = [
            'spazAttack01',
