...
class ServerConfig:
    ...
    # Rainbow text displayed at the bottom of the screen. Main purpose was for
    # showing donation info.
    support_text: str | None = None

    # Single color texts displayed on top of eachother at the bottom of the
    # screen. Main purpose was for promoting the servers' socials.
    social_texts: list[
    ...
    # If True and your party is public, your party will be recognised by
    # overclocked clients, allowing players to find your party in the
    # overclocked server browser, this also hints clients that they can use the
    # overclocked admin panel in your party.
    overclocked_recognition: bool = True

    # If True, Some assets will be replaced and some features will be disabled
    # in order to allow vanilla BombSquad players to join your party.
    vanillaclocked: bool = False
    ...
    # Name of the "super" directory for this server. The super directory
    # is where this server should dump its non-global data.
    super_dir: str = 'default'

    # Whether players in this server have access to chaotic features or
    # not (eg. /wheel).
    allow_chaotic_commands: bool = True

    # Any value set in here overrides the same value in the game's config file.
    # Mainly used for changing overclocked settings. Changed values will NOT go
    # back to the default value after being commented/removed and need to be
    # explicitly set in order to change.
    ...
    # (internal) the size of the black hole in the village.
    bs9vbhs: float = 0.0
